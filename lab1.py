...
class VisualCrossingWeatherProvider(IWeatherProvider):
    ...
    def get_data(self, city, start_datetime, end_datetime):
        ...
        return data['locations']['Volgograd,Russia']['values']

class TestProvider(IWeatherProvider):
    def get_data(self, city, start_date, end_date):
        data = {
          "columns": {
            "wdir": {
